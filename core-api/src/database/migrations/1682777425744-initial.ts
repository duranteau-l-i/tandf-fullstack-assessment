...
export class initial1682777425744 implements MigrationInterface {
    name = 'initial1682777425744'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "appointment" ("id" SERIAL NOT NULL, "startTime" character varying NOT NULL, "durationMinutes" integer NOT NULL DEFAULT '15', "doctorId" integer, CONSTRAINT "PK_e8be1a53027415e709ce8a2db74" PRIMARY KEY ("id"))`);
